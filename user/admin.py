...
class UserAdmin(admin.ModelAdmin):
    ...
    display_fields = ['email', 'name', 'is_organizer', 'is_volunteer', 'is_director', 'is_external']
    filter_fields = ['is_external', 'is_volunteer', 'is_director', 'is_organizer', 'is_admin', 'email_verified']
    permission_fields = ['is_external', 'is_volunteer', 'is_director', 'is_organizer', 'is_admin', 'email_verified']
