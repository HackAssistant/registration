...
HACKATHON_APP_DEADLINE = timezone.datetime(2022, 4, 22, 23, 59, tzinfo=timezone.pytz.timezone(TIME_ZONE))
...
REIMBURSEMENT_DEADLINE = timezone.datetime(2022, 4, 29, 23, 59, tzinfo=timezone.pytz.timezone(TIME_ZONE))
